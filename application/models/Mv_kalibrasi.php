...
class Mv_kalibrasi extends CI_Model {
	...
	{
		$this->db->select('a.id_barang,a.nama,a.merk,a.type,a.SN,a.tahun,b.nama_ruangan,y.*');
		$this->db->from($this->table);
		$this->db->join("ruangan b","a.id_ruangan = b.id_ruangan",'left');
		
		$this->db->join("kalibrasi y","a.id_barang = y.id_barang");
