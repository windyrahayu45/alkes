...
class Mv_afkir extends CI_Model {
	...
	{
		$this->db->select('a.id_barang,a.nama,a.merk,a.type,a.SN,a.tahun,b.nama_ruangan,c.status_barang,y.tgl,x.nama,y.ket');
		$this->db->from($this->table);
		$this->db->join("ruangan b","a.id_ruangan = b.id_ruangan",'left');
		$this->db->join("status_barang c","a.id_status = c.id_status",'left');
		$this->db->join("afkir y","a.id_barang = y.id_barang");
		$this->db->join("petugas x","y.id_petugas = x.id_petugas",'left');
