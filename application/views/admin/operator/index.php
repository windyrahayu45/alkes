...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="<?=base_url('operator')?>">Components</a></div>
      <div class="breadcrumb-item">Admin Modul</div>
    </div>
  </div>

  <div class="section-body">
    <h2 class="section-title">Admin Modul</h2>
    <p class="section-lead">Daftar admin untuk setting data modul</p>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
      table = $('#table-module').DataTable({ 
        ...
        "serverSide": true, 
        "ajax": {
          "url": "<?php echo site_url('operator/get_data')?>",
          "type": "POST"
        },
    ...
    $(document).on('click',"#add-button",function(){
      $.ajax({
        url: '<?php echo site_url('operator/modal'); ?>',
        type: 'post',
