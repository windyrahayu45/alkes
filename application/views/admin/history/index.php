...
<section class="section">
          <div class="section-header">
            <h1>Data Tgl Pemeliharaan</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="<?=base_url()?>">Dashboard</a></div>
              <div class="breadcrumb-item"><a href="<?=base_url('history')?>">Components</a></div>
              <div class="breadcrumb-item">Tgl Pemeliharaan Terakhir</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Tgl Pemeliharaan</h2>
            <p class="section-lead">Atur Data tgl Pemeliharaan Terakhir</p>
              ...
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4>Tgl Pemeliharaan Terakhir</h4>
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered table-md" id="table-module">
                          ...
                          <tr>
                            <td>Tgl Pemeliharaan Terakhir</td>
                            <td><?=$history->tgl?></td>

                            <td><button type="button" id="add-button" class="btn btn-primary">Edit Tgl</button></td>
                          </tr>
                        </table>
                    </div>
                  </div>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title">Ubah Data Tgl Pemeliharaan Terakhir</h5>
    ...
    <div class="modal-body">
          <div class="form-group">
            ...
            <input type="date" name="tgl" id="tgl" class="form-control" required="" value="<?=$history->tgl?>">
