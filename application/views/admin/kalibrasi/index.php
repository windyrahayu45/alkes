...
<section class="section">
          <div class="section-header">
            <h1>Kalibrasi Alat</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="<?=base_url()?>">Dashboard</a></div>
              <div class="breadcrumb-item"><a href="<?=base_url('kalibrasi')?>">Components</a></div>
              <div class="breadcrumb-item">Kartu Kalibrasi</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Kalibrasi</h2>
            <p class="section-lead">Rekapan kalibrasi</p>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
      ...
      table = $('#table-module').DataTable({ 
        ...
        "ajax": {
          "url": "<?php echo site_url('kalibrasi/get_data')?>",
          "type": "POST"
        },
