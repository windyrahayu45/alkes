...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="<?=base_url('peralatan')?>">Components</a></div>
  ...
  <div class="section-body">
    ...
    <p class="section-lead">Daftar Peralatan Medis Per Ruangan</p>
    ...
    $(document).ready( function () {
      ...
      table = $('#table-module').DataTable({ 
       dom: 'Bfrtip',
        ...
        "ajax": {
          "url": "<?php echo site_url('peralatan/get_data')?>",
          "type": "POST",
          "data": function ( data ) {
