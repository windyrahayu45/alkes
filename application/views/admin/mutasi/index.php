...
<section class="section">
          <div class="section-header">
            <h1>Data Mutasi Alat</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="<?=base_url()?>">Dashboard</a></div>
              <div class="breadcrumb-item"><a href="<?=base_url('mutasi')?>">Components</a></div>
              <div class="breadcrumb-item">Data Mutasi Alat</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Data Mutasi Alat</h2>
            <p class="section-lead">Rekapan semua mutasi</p>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
      ...
      table = $('#table-module').DataTable({ 
        ...
        "ajax": {
          "url": "<?php echo site_url('Mutasi/get_data')?>",
          "type": "POST",
           "data": function ( data ) {
            data.ruangan = $('#params').val();
