...
<section class="section">
          <div class="section-header">
            <h1>Data Afkir Alat</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="<?=base_url()?>">Dashboard</a></div>
              <div class="breadcrumb-item"><a href="<?=base_url('afkir')?>">Components</a></div>
              <div class="breadcrumb-item">Data Afkir Alat</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Data Afkir Alat</h2>
            <p class="section-lead">Rekapan semua afkir</p>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
      ...
      table = $('#table-module').DataTable({ 
        ...
        "ajax": {
          "url": "<?php echo site_url('afkir/get_data')?>",
          "type": "POST"
        },
